...
#define SL_UARTDRV_EUSART_INST0_TX_PORT           gpioPortA
#define SL_UARTDRV_EUSART_INST0_TX_PIN            0

#define SL_UARTDRV_EUSART_INST0_RX_PORT           gpioPortA
#define SL_UARTDRV_EUSART_INST0_RX_PIN            1

#define SL_UARTDRV_EUSART_INST0_CTS_PORT          gpioPortA
#define SL_UARTDRV_EUSART_INST0_CTS_PIN           2
...
// #define SL_UARTDRV_EUSART_INST0_PERIPHERAL        EUART0
// #define SL_UARTDRV_EUSART_INST0_PERIPHERAL_NO     0
